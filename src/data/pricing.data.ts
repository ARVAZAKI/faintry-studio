...
export const pricingData: PricingPackage[] = [
  {
    ...
    features: [
      ...
      { label: 'Search Engine Optimization (SEO)', included: true },
      { label: 'Revisi 1x', included: true },
      { label: 'Gratis Domain .com 1 Tahun', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Garansi Pemeliharaan 6 Bulan', included: true },
    ],
  },
];
